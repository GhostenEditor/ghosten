...
export function getContextMenus(gt: GtEdit, gtNode: GtNode, overlay: Overlay) {
  return [
    {
      ...
      onclick: () =>
        gt.dropNode(
          gtNode,
          gtNode.parent!,
          gtNode.parent!.children.indexOf(gtNode) - 1,
        ),
    },
    {
      ...
      disabled: !(
        ...
        gtNode.parent.children.indexOf(gtNode) <
          gtNode.parent.children.length - 1
      ),
      onclick: () =>
        gt.dropNode(
          gtNode,
    ...
    },
    {
      ...
      onclick: () =>
        gt.dropNode(
          gtNode,
          gtNode.parent!.parent!,
          gtNode.parent!.parent!.children.indexOf(gtNode.parent!) + 1,
        ),
    },
    {
      divider: true,
