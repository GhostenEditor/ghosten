...
/**
 * Tree flattener to convert icon.svg normal type of node to node with children & level information.
...
export class TreeFlattener<T, F, K = F> {
  ...
  /**
   * Flatten icon.svg list of node type T to flattened version of node F.
