...
@Component({
  ...
  template: ` <div class="border-box mb-2">
      <div
        class="border-item border-all"
        [class.active]="active === 'all'"
        (click)="switchBorder('all')"
      ></div>
      <div
        class="border-item border-left "
        [class.active]="active === 'left'"
        (click)="switchBorder('left')"
      ></div>
      <div
        class="border-item border-top"
        [class.active]="active === 'top'"
        (click)="switchBorder('top')"
      ></div>
      <div
        class="border-item border-right"
        [class.active]="active === 'right'"
        (click)="switchBorder('right')"
      ></div>
      <div
      ...
      >
        <li
          *ngFor="let item of items"
          (click)="changeDropdown(type, item)"
