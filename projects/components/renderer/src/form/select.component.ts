...
@Component({
  ...
  template: `
    <label class="form-label" *ngIf="gtNode.property.showLabel">{{ gtNode.property.labelText | dataBinding }}</label>
    <div class="input-group has-validation" [ngClass]="property.inputSize">
      <ng-container *ngIf="formGroup" [formGroup]="formGroup">
        ...
        >
          ...
          <option *ngFor="let option of property.options | dataBinding" [attr.value]="option[property.valueField]">
      ...
      <ng-container *ngIf="!formGroup">
        <select
          ...
          [multiple]="property.multiple"
        >
          <option value="" [attr.selected]="ngModel.control.value === null"></option>
          <option *ngFor="let option of property.options | dataBinding" [attr.value]="option.value">
            {{ option.label }}
          </option>
        </select>
