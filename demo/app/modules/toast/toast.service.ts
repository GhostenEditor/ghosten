...
export class ToastService {
  private componentRefs: Partial<Record<ToastPositions, ComponentRef<ToastComponent>>> = {};
  ...
  show(toast: IToast) {
    ...
    if (!this.componentRefs[position]) {
      this.componentRefs[position] = this.overlay.create().attach(new ComponentPortal(ToastComponent));
